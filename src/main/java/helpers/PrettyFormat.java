    ...
    public static void connectingFlightTable(Flight flight1, List<Flight> listFlights){
        if (listFlights.size() > 0) {
            System.out.printf("%-8d%-15s%-22s%-15s%-22s",
                    ...
                    flight1.getDepartureTime().format(DateTimeFormatter.ofPattern("HH:mm   dd-MM-yyyy")),
                    flight1.getArrivalPlace(),
                    flight1.getArrivalTime().format(DateTimeFormatter.ofPattern("HH:mm   dd-MM-yyyy")));
            ...
            for (int i = 0; i < listFlights.size(); i++) {
                ...
                System.out.printf("%-12s%-8d%-15s%-22s%-15s%-22s%n",
                        ...
                        listFlights.get(i).getDepartureTime().format(DateTimeFormatter.ofPattern("HH:mm   dd-MM-yyyy")),
                        listFlights.get(i).getArrivalPlace(),
                        listFlights.get(i).getArrivalTime().format(DateTimeFormatter.ofPattern("HH:mm   dd-MM-yyyy")));
            }
        }
    }
